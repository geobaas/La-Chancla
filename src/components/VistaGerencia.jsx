...
export default function VistaGerencia({ platillos }) {
  ...
  // Variables alineadas EXACTAMENTE con tu Firebase
        ...
        {vistaActual === 'inicio' && (
          <div className="dashboard-inicio">
            ...
            <div className="dashboard-grid">
              <button className="dash-action-btn" onClick={() => setVistaActual('agregarPlatillo')}>
                <span className="icon">🌮</span>
                <h3>Agregar Platillo</h3>
                <p>Registra un nuevo producto para la venta</p>
              </button>
              <button className="dash-action-btn" onClick={() => setVistaActual('crearCategoria')}>
                <span className="icon">📁</span>
                <h3>Crear Categoría</h3>
                <p>Añade secciones (Ej. Bebidas, Combos)</p>
              </button>
              <button className="dash-action-btn" onClick={() => setVistaActual('verMenu')}>
                <span className="icon">📋</span>
                <h3>Gestionar Menú</h3>
                <p>Edita inventario o elimina platillos</p>
              </button>
            </div>
          </div>
        )}
              ...
              <tbody>
                {platillos.map(p => (
                  <tr key={p.id}>
                    ...
                    {/* Lee id_categoria en lugar de categoria */}
